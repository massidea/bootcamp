...
<body>
	<!--[if lt IE 7]> <span id="iewhine">Internet Explorer version 6 and below are not supported. IE6 Sucks! Please update your browser for your own security.<br/> <a href="http://www.microsoft.com/windows/internet-explorer/worldwide-sites.aspx">Download newer version here</a> </span><![endif]-->
